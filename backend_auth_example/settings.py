...
SECRET_KEY = 'django-insecure-p@!#9_ft0kbf67&8qwwo_xc&nxg)_+nbyq)0x*40(4_7*ize6!'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_TIMELIFE'   : timedelta(minutes=10),
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': {
        'rest_framewoirk.permissions.AllowAny',
    },
